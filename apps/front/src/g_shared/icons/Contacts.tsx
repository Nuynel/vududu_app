...
const ContactsIcon = ({color}: IconProps) => {
  return (
    <div style={{width: 24, height: 24}}>
      <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        ...
        <path
          ...
          fill="none" stroke={color} strokeMiterlimit="10" strokeWidth="32"/>
        <path
          d="M200 185.94c-2.34 32.48-26.72 58.06-53 58.06s-50.7-25.57-53-58.06C91.61 152.15 115.34 128 147 128s55.39 24.77 53 57.94z"
          fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="32"/>
        <path
          d="M206 306c-18.05-8.27-37.93-11.45-59-11.45-52 0-102.1 25.85-114.65 76.2-1.65 6.66 2.53 13.25 9.37 13.25H154"
          fill="none" stroke={color} strokeLinecap="round" strokeMiterlimit="10" strokeWidth="32"/>
      </svg>
    </div>
  )
}
